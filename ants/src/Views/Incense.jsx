...
import incense from "../Assets/oud.png";
        ...
        <div className="collection-content">
          <div className="crystals-item">
            ...
            <div className="collection-item-img">
              <img src={incense} alt="crystals" width="235px" height="270px" />
            </div>
            <p className="collection-item-text">Vanilla</p>
            </Link>
          ...
          <div className="crystals-item">
            <Link style={{textDecoration: 'none'}} to="/shop/crystals">
            <div className="collection-item-img">
              <img src={incense} alt="clothing" width="235px" height="270px" />
            </div>
            <p className="collection-item-text">Choclate</p>
            </Link>
            <p className="price">0.00$</p>
          </div>
          <div className="crystals-item">
            <Link style={{textDecoration: 'none'}} to="/shop/crystals">
            <div className="collection-item-img">
              <img src={incense} alt="jewelry" width="235px" height="270px" />
            </div>
            <p className="collection-item-text">Oud</p>
            </Link>
            <p className="price">0.00$</p>
          </div>
          <div className="crystals-item">
            ...
            <p className="collection-item-text">Lavender</p>
            </Link>
            <p className="price">0.00$</p>
          </div>
        </div>
      ...
      <div className="middle-crystals-content">
        <div className="collection-content">
          <div className="crystals-item">
            ...
            <p className="collection-item-text">Rose</p>
            </Link>
            <p className="price">0.00$</p>
          </div>
          <div className="crystals-item">
            ...
            <p className="collection-item-text">Jasmine</p>
            </Link>
            <p className="price">0.00$</p>
          </div>
          <div className="crystals-item">
            ...
            <p className="collection-item-text">White Sage</p>
            </Link>
            <p className="price">0.00$</p>
          </div>
          <div className="crystals-item">
            ...
            <p className="collection-item-text">Cedar</p>
            </Link>
            <p className="price">0.00$</p>
          </div>
        </div>
